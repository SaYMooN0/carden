<script>
import DialogWithCloseButton from '$lib/DialogWithCloseButton.svelte';
...
<button onclick={prevPlant}>
    &lt;
</button>
<img src={plants[plantIndex]} alt="Plant"/>
<button onclick={nextPlant}>
    &gt;
</button>

<h3>Выберите горшок</h3>
<button onclick={prevPot}>
    &lt;
</button>
<img src={pots[potIndex]} alt="Pot"/>
<button onclick={nextPot}>
    &gt;
</button>
